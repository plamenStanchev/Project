namespace Scheduler.Services.Data.Tests.Services.UserServiceTestAsets
{
    ...
    public static class MockHelpers
    {
        ...
        public static Mock<UserManager<TUser>> MockUserManager<TUser>(IUserStore<ApplicationUser> store)
            where TUser : class
        {
